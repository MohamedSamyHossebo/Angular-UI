...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">fd-assignment documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ClientDetailsComponent.html" data-type="entity-link" >ClientDetailsComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/ClientListComponent.html" data-type="entity-link" >ClientListComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/DealDetailsComponent.html" data-type="entity-link" >DealDetailsComponent</a>
                            </li>
                            <li class="link">
